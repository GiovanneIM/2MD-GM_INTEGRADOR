...
export default function Calendario({
    ...
    function swalSessao(sessao) {
        const eHoje = (dataAtual === sessao.dia);
        ...
        Swal.fire({
            ...
            html: `
                <div class='text-start p-3 border rounded' style='background:#f8f9fa;'>
                    <table class='table table-sm mb-0'>
                        <tbody>
                            ...
                            <div class='mt-3'>
                                <div class='fw-bold'>Data da sessão(a)</div>
                ...
                <div class='mt-3'>
                    ...
                    <button id='btnCancelarSessao' class='swal2-confirm swal2-styled border bg-danger'>
                    ...
                    <button id='btnConcluirSessao' class='swal2-confirm swal2-styled border bg-success' ${!eHoje ? "" : "disabled"})>
